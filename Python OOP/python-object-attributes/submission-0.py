...
#print("Initial Attributes: Whiskers (cat) - ","Hunger:",whiskers.hunger,", Energy:",whiskers.energy)
...
#print("Modified Attributes: Whiskers (cat) - ","Hunger:",whiskers.hunger,", Energy:",whiskers.energy)
